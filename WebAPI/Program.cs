        ...
        public static async Task Main(string[] args)
        {
            ...
            builder.Services.AddSwaggerGen(opt =>
            {
                ...
                opt.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme
                {
                    ...
                    Description = "Lütfen sadece token metnini buraya yapıştırın.",
                    Name = "Authorization",
            ...
            // --- 3. VERİTABANI & REPOSITORY KAYITLARI ---
            ...
            // --- 5. AUTHENTICATION (KİMLİK) & AUTHORIZATION (YETKİ) ---
            ...
            builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
                .AddJwtBearer(options =>
                {
                    ...
                    // Hata ayıklama logları (Debug penceresinde görünür)
                    options.Events = new JwtBearerEvents
                    {
                        ...
                        OnChallenge = context => {
                            System.Diagnostics.Debug.WriteLine("!!! UYARI: Sunucuya token gelmedi veya format hatalı.");
                            return Task.CompletedTask;
                        }
                    };
                });
            ...
            // --- PIPELINE SIRALAMASI (BURASI HAYATİ ÖNEMDEDİR) ---
